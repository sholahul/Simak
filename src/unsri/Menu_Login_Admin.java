 ...
 */
public class Menu_Login_Admin extends javax.swing.JFrame {

    /**
     * Creates new form Menu_Login
     */
    public Menu_Login_Admin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/formmenu.jpg"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/home (2).png"))); // NOI18N
    ...
    private void gomenu(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gomenu
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{//menciptkan objek statement dari utility statement dimana nantinya akan menangkap fungsi dari 
            ...
            */
            ...
            if(result.next())
            {
                if(pass_admin.getText().equals(result.getString("password")))
                {
                    Madm.setVisible(true); //setvisible bawakan jswing yang mana fungsi yang mengembalikan form jswing
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Login_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Login_Admin().setVisible(true);
            }
        });
    }
