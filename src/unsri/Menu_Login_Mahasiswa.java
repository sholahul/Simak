 ...
 */
public class Menu_Login_Mahasiswa extends javax.swing.JFrame {

    /**
     * Creates new form Menu_Login
     */
    public Menu_Login_Mahasiswa() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Login_Mahasiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Login_Mahasiswa().setVisible(true);
            }
        });
    }
